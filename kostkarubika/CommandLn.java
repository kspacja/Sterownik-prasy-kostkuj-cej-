...
public static String fileName="";
    ...
    public static String createCommand(String silnik, int stopnie, int obroty, int unlimited, int moc){
        ...
        if (moc==0){
        command = "java "+fileName+" motor-stop "+silnik;
        }
        return(command);
    ...
    public static String SetCommand(int nrCzujnika, int rodzCzujnika){
        ...
        if(rodzCzujnika==3){
            ...
            command = "java "+fileName+" set-sensor "+nrCzujnika+" type=color";
        }
        if(rodzCzujnika==4){
    ...
    public static String GetSensor(int nrCzujnika){
        String command="";        
        command = "java "+fileName+" get-sensor "+nrCzujnika+" -t 400";
        //command ="ipconfig";
        return command;
    }
    ...
    public static void resetMotor(String m){
        Runtime rt = Runtime.getRuntime();

        String commandToSend="java "+fileName+" reset-motor-position "+m;;
